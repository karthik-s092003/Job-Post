...
const applyJob = async (req,res) =>{
    const {FirstName,LastName,Email ,Reason,City,State,Country,jobId,companyId,resumeUrl,empId} = req.body
    if(!FirstName||!LastName||!Email||!Reason||!City||!State||!Country||!jobId||!companyId||!resumeUrl||!empId){
        const body = req.body;
        console.log(body);
