      ...
      <div className='w-full h-[90%] flex'>
        ...
        <div className='w-[50%] h-full flex flex-col justify-center items-start gap-4 p-5 '>
            ...
            <div className="w-full flex ">
              ...
              <Link to={"/company/signin"} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >Offer jobs</Link>
            </div>
        </div>
      </div>
    </div>
