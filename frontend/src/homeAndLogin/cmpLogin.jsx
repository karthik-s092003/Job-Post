...
import { company_signIn } from "../jobPost/services/jobPost";
          ...
          <div className="p-12 bg-white mx-auto rounded-3xl w-96">
            <div className="mb-7">
              ...
              <p className="text-gray-400">
                ...
                <a href="/job-post-signup" className="text-sm text-blue-700 hover:text-blue-700">
                  Sign Up
                </a>
              </p>
            </div>
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm ml-auto">
                  <a href="/job-post-signin" className="text-blue-700 hover:text-blue-600">
              ...
              <div>
                ...
                >
                  {isloading?<FaSpinner className="animate-spin text-white" size={20} />:<p>Sign In</p>}
                </button>
              </div>
